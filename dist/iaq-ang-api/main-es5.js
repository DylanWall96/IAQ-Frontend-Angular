(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! /Users/Dylan/Downloads/iaqFrontend 2/src/main.ts */
      "zUnb");
      /***/
    },
      ...
      var DataService = /*#__PURE__*/function () {
        ...
        _createClass(DataService, [{
          ...
          value: function getData() {
            return this.http.get("".concat(this.apiServerUrl));
          }
        }, {
          key: "getKitchenData",
          value: function getKitchenData() {
            return this.http.get("".concat(this.apiServerUrl, "/data/chart/kitchen"));
          }
        }, {
          key: "getBarData",
          value: function getBarData() {
            return this.http.get("".concat(this.apiServerUrl, "/data/chart/bar"));
          }
        }, {
          key: "getOfficeData",
          value: function getOfficeData() {
            return this.http.get("".concat(this.apiServerUrl, "/data/chart/office"));
          }
        }]);
    ...
    function ZAI4(module, __webpack_exports__, __webpack_require__) {
      ...
      var _components_kitchen_kitchen_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./components/kitchen/kitchen.component */
      "jVS5");
      /* harmony import */
      ...
      var src_app_data_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      AppModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineNgModule"]({
        type: AppModule,
        bootstrap: [_components_kitchen_kitchen_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"]]
      });
      AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵdefineInjector"]({
        ...
        imports: [[_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"].forRoot([{
          path: 'kitchen',
          component: _components_kitchen_kitchen_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"]
        }]), _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModule"]]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_7__["ɵɵsetNgModuleScope"](AppModule, {
          declarations: [_components_kitchen_kitchen_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"]],
          imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_router__WEBPACK_IMPORTED_MODULE_6__["RouterModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClientModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModule"]]
        });
      })();
      /***/
    ...
    /***/
    function jVS5(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var node_modules_chart_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! node_modules/chart.js */
      "MO+k");
      /* harmony import */


      var node_modules_chart_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(node_modules_chart_js__WEBPACK_IMPORTED_MODULE_0__);
      /* harmony import */
      ...
      var src_app_data_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! src/app/data.service */
      "R7Hv");
      /* harmony import */
      ...
      var AppComponent = /*#__PURE__*/function () {
        function AppComponent(dataService) {
          ...
          setInterval(function () {
            _this.now = new Date().toString().split(' ')[4];
          }, 1);
        }
        ...
        _createClass(AppComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.kitchenTimer = setInterval(function () {
              clearInterval(_this2.countdownTimer);

              _this2.getOfficeData();
          ...
          value: function officeFunc() {
            ...
            jquery__WEBPACK_IMPORTED_MODULE_1__('#last-recorded').html('DATA LOADING...');
            this.startTimer();
            this.officeTimer = setInterval(function () {
              clearInterval(_this4.countdownTimer);

              _this4.getOfficeData();
          ...
          value: function barFunc() {
            ...
            this.barTimer = setInterval(function () {
              clearInterval(_this5.countdownTimer);
          ...
          value: function startTimer() {
            ...
            this.countdownTimer = setInterval(function () {
              if (_this6.counter.sec - 1 == -1) {
                _this6.counter.sec = 59;
              } else _this6.counter.sec -= 1;

              if (_this6.counter.sec == 0) clearInterval(_this6.countdownTimer);
            }, 1000);
          }
        }, {
          key: "getKitchenData",
          value: function getKitchenData() {
            ...
            this.dataService.getKitchenData().subscribe(function (response) {
              _this7.data = response;

              for (var i in response) {
                _this7.timestamp.push(response[i].timestamp);

                _this7.temperature.push(response[i].temp);

                _this7.gas.push(response[i].gas);

                _this7.pres.push(response[i].pres);

                _this7.hum.push(response[i].hum);

                _this7.score.push(response[i].score);

                _this7.location.push(response[i].location);

                _this7.kitchenavg.push(response[i].kitchenavg);

                _this7.kitchenhouravg.push(response[i].kitchenhouravg);

                _this7.formattedTime.push(moment__WEBPACK_IMPORTED_MODULE_2__(_this7.timestamp[_this7.timestamp.length - 1], 'YYYY-MM-DD HH:mm:ss').fromNow());

                jquery__WEBPACK_IMPORTED_MODULE_1__('#temp').html(_this7.temperature[_this7.temperature.length - 1] + "\xB0C");
                jquery__WEBPACK_IMPORTED_MODULE_1__('#hum').html(_this7.hum[_this7.hum.length - 1] + '%');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#pres').html(_this7.pres[_this7.pres.length - 1] + 'hPa');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#gas').html(_this7.gas[_this7.gas.length - 1] + 'k&#8486;');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#kitchenavg').html(_this7.kitchenavg[_this7.kitchenavg.length - 1] + 'k&#8486;');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#kitchenhouravg').html(_this7.kitchenhouravg[_this7.kitchenhouravg.length - 1] + 'k&#8486;');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#score').html(_this7.score[_this7.score.length - 1] + ' IAQ');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#last-recorded').html(_this7.formattedTime[_this7.formattedTime.length - 1]);
                jquery__WEBPACK_IMPORTED_MODULE_1__('#location').html(_this7.location[_this7.location.length - 1]);
                /* IAQ Alerts according BME680 datasheet */

                if (_this7.score[_this7.score.length - 1] <= 50) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-success" role="alert">Air Quality - Good!</div>');
                } else if (_this7.score[_this7.score.length - 1] >= 51 && _this7.score[_this7.score.length - 1] <= 100) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-success" role="alert">Air Quality - Average!</div>');
                } else if (_this7.score[_this7.score.length - 1] >= 101 && _this7.score[_this7.score.length - 1] <= 150) {
                ...
                } else if (_this7.score[_this7.score.length - 1] >= 151 && _this7.score[_this7.score.length - 1] <= 200) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-warning" role="alert">Air Quality - Unhealthy!</div>');
                } else if (_this7.score[_this7.score.length - 1] >= 201 && _this7.score[_this7.score.length - 1] <= 300) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-danger" role="alert">Air Quality - Very Unhealthy!</div>');
                } else if (_this7.score[_this7.score.length - 1] >= 301) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-danger" role="alert">Air Quality - Hazardous!</div>');
                }

                if (_this7.timestamp.length == 60) {
                  _this7.timestamp.shift();
                }

                if (_this7.temperature.length == 60) {
                  _this7.temperature.shift();
                }

                if (_this7.hum.length == 60) {
                  _this7.hum.shift();
                }

                if (_this7.pres.length == 60) {
                  _this7.pres.shift();
                }

                if (_this7.gas.length == 60) {
                  _this7.gas.shift();
                }

                if (_this7.score.length == 60) {
                  _this7.score.shift();
                }
              }
              ...
              var tempGraph = new node_modules_chart_js__WEBPACK_IMPORTED_MODULE_0__["Chart"]('tempGraph', {
                type: 'line',
                data: {
                  labels: _this7.timestamp,
                  datasets: [{
                    label: "Temperature Data (\xB0C)",
                    backgroundColor: '#0275d8',
                    borderColor: '#0275d8',
                    hoverBackgroundColor: '#CCCCCC',
                    hoverBorderColor: '#666666',
                    data: _this7.temperature,
                    fill: false
                  }]
                },
                options: {
          ...
          value: function getOfficeData() {
            ...
            this.dataService.getOfficeData().subscribe(function (response) {
              _this8.data = response;

              for (var i in response) {
                _this8.timestamp.push(response[i].timestamp);

                _this8.temperature.push(response[i].temp);

                _this8.gas.push(response[i].gas);

                _this8.pres.push(response[i].pres);

                _this8.hum.push(response[i].hum);

                _this8.score.push(response[i].score);

                _this8.location.push(response[i].location);

                _this8.kitchenavg.push(response[i].kitchenavg);

                _this8.kitchenhouravg.push(response[i].kitchenhouravg);

                _this8.formattedTime.push(moment__WEBPACK_IMPORTED_MODULE_2__(_this8.timestamp[_this8.timestamp.length - 1], 'YYYY-MM-DD HH:mm:ss').fromNow());

                jquery__WEBPACK_IMPORTED_MODULE_1__('#temp').html(_this8.temperature[_this8.temperature.length - 1] + "\xB0C");
                jquery__WEBPACK_IMPORTED_MODULE_1__('#hum').html(_this8.hum[_this8.hum.length - 1] + '%');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#pres').html(_this8.pres[_this8.pres.length - 1] + 'hPa');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#gas').html(_this8.gas[_this8.gas.length - 1] + 'k&#8486;');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#kitchenavg').html(_this8.kitchenavg[_this8.kitchenavg.length - 1] + 'k&#8486;');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#kitchenhouravg').html(_this8.kitchenhouravg[_this8.kitchenhouravg.length - 1] + 'k&#8486;');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#score').html(_this8.score[_this8.score.length - 1] + ' IAQ');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#last-recorded').html(_this8.formattedTime[_this8.formattedTime.length - 1]);
                jquery__WEBPACK_IMPORTED_MODULE_1__('#location').html(_this8.location[_this8.location.length - 1]);
                /* IAQ Alerts according BME680 datasheet */

                if (_this8.score[_this8.score.length - 1] <= 50) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-success" role="alert">Air Quality - Good!</div>');
                } else if (_this8.score[_this8.score.length - 1] >= 51 && _this8.score[_this8.score.length - 1] <= 100) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-success" role="alert">Air Quality - Average!</div>');
                } else if (_this8.score[_this8.score.length - 1] >= 101 && _this8.score[_this8.score.length - 1] <= 150) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-warning" role="alert">Air Quality - Unhealthy for Sensitive Groups!</div>');
                } else if (_this8.score[_this8.score.length - 1] >= 151 && _this8.score[_this8.score.length - 1] <= 200) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-warning" role="alert">Air Quality - Unhealthy!</div>');
                } else if (_this8.score[_this8.score.length - 1] >= 201 && _this8.score[_this8.score.length - 1] <= 300) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-danger" role="alert">Air Quality - Very Unhealthy!</div>');
                } else if (_this8.score[_this8.score.length - 1] >= 301) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-danger" role="alert">Air Quality - Hazardous!</div>');
                }

                if (_this8.timestamp.length == 60) {
                  _this8.timestamp.shift();
                }

                if (_this8.temperature.length == 60) {
                  _this8.temperature.shift();
                }

                if (_this8.hum.length == 60) {
                  _this8.hum.shift();
                }

                if (_this8.pres.length == 60) {
                  _this8.pres.shift();
                }

                if (_this8.gas.length == 60) {
                  _this8.gas.shift();
                }

                if (_this8.score.length == 60) {
                  _this8.score.shift();
                }
              }
          ...
          value: function getBarData() {
            ...
            this.dataService.getBarData().subscribe(function (response) {
              _this9.data = response;

              for (var i in response) {
                _this9.timestamp.push(response[i].timestamp);

                _this9.temperature.push(response[i].temp);

                _this9.gas.push(response[i].gas);

                _this9.pres.push(response[i].pres);

                _this9.hum.push(response[i].hum);

                _this9.score.push(response[i].score);

                _this9.location.push(response[i].location);

                _this9.kitchenavg.push(response[i].kitchenavg);

                _this9.kitchenhouravg.push(response[i].kitchenhouravg);

                _this9.formattedTime.push(moment__WEBPACK_IMPORTED_MODULE_2__(_this9.timestamp[_this9.timestamp.length - 1], 'YYYY-MM-DD HH:mm:ss').fromNow());

                jquery__WEBPACK_IMPORTED_MODULE_1__('#temp').html(_this9.temperature[_this9.temperature.length - 1] + "\xB0C");
                jquery__WEBPACK_IMPORTED_MODULE_1__('#hum').html(_this9.hum[_this9.hum.length - 1] + '%');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#pres').html(_this9.pres[_this9.pres.length - 1] + 'hPa');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#gas').html(_this9.gas[_this9.gas.length - 1] + 'k&#8486;');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#kitchenavg').html(_this9.kitchenavg[_this9.kitchenavg.length - 1] + 'k&#8486;');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#kitchenhouravg').html(_this9.kitchenhouravg[_this9.kitchenhouravg.length - 1] + 'k&#8486;');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#score').html(_this9.score[_this9.score.length - 1] + ' IAQ');
                jquery__WEBPACK_IMPORTED_MODULE_1__('#last-recorded').html(_this9.formattedTime[_this9.formattedTime.length - 1]);
                jquery__WEBPACK_IMPORTED_MODULE_1__('#location').html(_this9.location[_this9.location.length - 1]);
                /* IAQ Alerts according BME680 datasheet */

                if (_this9.score[_this9.score.length - 1] <= 50) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-success" role="alert">Air Quality - Good!</div>');
                } else if (_this9.score[_this9.score.length - 1] >= 51 && _this9.score[_this9.score.length - 1] <= 100) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-success" role="alert">Air Quality - Average!</div>');
                } else if (_this9.score[_this9.score.length - 1] >= 101 && _this9.score[_this9.score.length - 1] <= 150) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-warning" role="alert">Air Quality - Unhealthy for Sensitive Groups!</div>');
                } else if (_this9.score[_this9.score.length - 1] >= 151 && _this9.score[_this9.score.length - 1] <= 200) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-warning" role="alert">Air Quality - Unhealthy!</div>');
                } else if (_this9.score[_this9.score.length - 1] >= 201 && _this9.score[_this9.score.length - 1] <= 300) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-danger" role="alert">Air Quality - Very Unhealthy!</div>');
                } else if (_this9.score[_this9.score.length - 1] >= 301) {
                  jquery__WEBPACK_IMPORTED_MODULE_1__('#IAQ-box').html('<div class="alert alert-danger" role="alert">Air Quality - Hazardous!</div>');
                }

                if (_this9.timestamp.length == 60) {
                  _this9.timestamp.shift();
                }

                if (_this9.temperature.length == 60) {
                  _this9.temperature.shift();
                }

                if (_this9.hum.length == 60) {
                  _this9.hum.shift();
                }

                if (_this9.pres.length == 60) {
                  _this9.pres.shift();
                }

                if (_this9.gas.length == 60) {
                  _this9.gas.shift();
                }

                if (_this9.score.length == 60) {
                  _this9.score.shift();
                }
              }
      ...
      AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        ...
        template: function AppComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AppComponent_Template_button_click_12_listener() {
              return ctx.kitchenFunc();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵlistener"]("click", function AppComponent_Template_button_click_14_listener() {
              return ctx.officeFunc();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](66, " \xB0C ");
        ...
        directives: [_ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbDropdown"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbDropdownToggle"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbDropdownMenu"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbDropdownItem"]],
